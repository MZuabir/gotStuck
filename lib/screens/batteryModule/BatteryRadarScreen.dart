...
import 'BatteryArrivalScreen.dart';

class BatteryRadarScreen extends StatefulWidget {
  const BatteryRadarScreen({super.key, required this.title});
  final String title;

  @override
  State<BatteryRadarScreen> createState() => _BatteryRadarScreenState();
}

class _BatteryRadarScreenState extends State<BatteryRadarScreen>
      ...
      setState(() {
        ...
        if (seconds == 5) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => BatteryArrivalScreen(
                        title: widget.title,
                      )));
        }
      });
                      ...
                      Padding(
                        ...
                        child: MediumText(
                          ...
                          style: const TextStyle(
                              ...
                              fontSize: 16),
                          text: seconds <= 2
                              ? 'Searching ${widget.title} Service Provider'
                              : (seconds > 2 && seconds < 4)
